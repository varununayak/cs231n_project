...
from utils import load_poses, load_images, cumulate_poses, plot_predictions_vs_truth, create_windowed_images, preprocess_data
import os
import argparse
from config import *
...
def main():
    ...
    # Load ground truth
    poses = load_poses('ground_truth_odometry/data_odometry_poses/dataset/poses/{}.txt'.format(sequence), get_only_translation=True)
    ...
    plot_predictions_vs_truth(rcnn_model.predict(images_windowed), poses_original, init_pose, using_absolute_pose_val)
